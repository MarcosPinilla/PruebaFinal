...
public class NotificacionDAO {
	...
	public static boolean save(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.PruebaFinalPersistentManager.instance().saveObject(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.PruebaFinalPersistentManager.instance().deleteObject(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.PruebaFinalPersistentManager.instance().getSession().refresh(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Notificacion notificacion) throws PersistentException {
		try {
			orm.PruebaFinalPersistentManager.instance().getSession().evict(notificacion);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
